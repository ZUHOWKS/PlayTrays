...
<template>
  <div class="container">
    <div class="column">
      <div class="title">
        <h2>Social</h2>
        <svg @click="showSocialWidget" xmlns="http://www.w3.org/2000/svg" class="close-button" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M368 368L144 144M368 144L144 368"/></svg>
      </div>
